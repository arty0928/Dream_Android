...
import com.dream.hyoja.fastfoods.adapter.SetMenuChoiceMainViewPagerAdapter
import com.dream.hyoja.databinding.FragmentChoiceSetMenuDialogBinding
import com.dream.hyoja.fastfoods.adapter.SetMenuChoiceCategoryAdapter
...
import com.dream.hyoja.fastfoods.util.setMenuFoodUtilValue
...
//                foodOptionFragmentManage()
    ...
    override fun onResume() {
        ...
        val width = size.x
        val height = size.y
        window?.setLayout((width * 0.9).toInt(), (height * 0.95).toInt())
