...
class CafeNewMenuTabActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            newViewPager.adapter= NewCafeAdapter(fragmentList, this@CafeNewMenuTabActivity.supportFragmentManager,lifecycle)
