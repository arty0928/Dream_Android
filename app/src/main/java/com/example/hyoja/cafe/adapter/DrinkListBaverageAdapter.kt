...
import com.example.hyoja.cafe.fragment.DrinkListBaverageFragment
...
class DrinkListBaverageAdapter (fragmentActivity: FragmentActivity): FragmentStateAdapter(fragmentActivity) {

    // 1. ViewPager2에 연결할 Fragment 들을 생성
    private val fragmentList = listOf<Fragment>(
        DrinkListBaverageFragment()
    )
